...
{ 
    public class DapperUsersTable
    {
        ...
        public async Task<ApplicationUser> FindByIdAsync(Guid userId)
        {
            ...
            using (var connection = await _databaseConnectionFactory.CreateConnectionAsync())
            {
                return await connection.QuerySingleOrDefaultAsync<ApplicationUser>(command, new
                {
                    Id = userId
                });
            }
        ...
        public async Task<IList<ApplicationUser>> GetUsersInRoleAsync(string roleName)
        {
            ...
            using (var connection = await _databaseConnectionFactory.CreateConnectionAsync())
            {
                return (await connection.QueryAsync<ApplicationUser>(command, new
                {
                    RoleName = roleName
                })).ToList();
            }
        ...
        public async Task<IEnumerable<ApplicationUser>> GetAllUsers()
        {
            ...
            using (var connection = await _databaseConnectionFactory.CreateConnectionAsync())
            {
                return await connection.QueryAsync<ApplicationUser>(command);
            }
        }
    }
}
