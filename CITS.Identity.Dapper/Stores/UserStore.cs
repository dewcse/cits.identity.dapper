...
namespace CITS.Identity.Dapper.Stores
{
	public class UserStore : IUserEmailStore<IdentityUser>, IUserLoginStore<IdentityUser>, IUserPasswordStore<IdentityUser>,
				IUserPhoneNumberStore<IdentityUser>, IUserTwoFactorStore<IdentityUser>, IUserSecurityStampStore<IdentityUser>, IUserClaimStore<IdentityUser>,
				IUserLockoutStore<IdentityUser>, IUserRoleStore<IdentityUser>, IUserAuthenticationTokenStore<IdentityUser>, IUserStore<IdentityUser> /*, IQueryableUserStore<ApplicationUser>*/
	{
